...
public class Main {
    public static void main(String[] args) {
        ...
        allergyRecords.add(new AllergyRecord("AL001", "P001", "Pollen", "Moderate"));

        MedicalHistoryService service = new MedicalHistoryService(patients, medRecords, allergyRecords);
        ...
        try {
            ...
            // Add allergy
            AllergyRecord a2 = new AllergyRecord("AL002", "P001", "Dust Allergy", "Mild");
